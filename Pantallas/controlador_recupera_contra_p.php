...
<input onkeypress="return /[a-zA-Z-ZáéíóúÁÉÍÓÚñÑ]/i.test(event.key)" oninput="this.value = this.value.toUpperCase();" onpaste="return false" oncopy="return false" class="controls" type="text" name="Usuario_Recupera" placeholder="Ingrese el Usuario" required>
...
.input-wrapper input {
padding-right: 162px; /* Ajusta el valor según el tamaño de tu ícono */
}
...
color: #aaa; /* Puedes ajustar el color del ícono según tus preferencias */
}
