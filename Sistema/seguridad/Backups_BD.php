...
$sql = "INSERT INTO tbl_registro_backup (ID_Registro_Backup, Actividad, ID_Usuario, Fecha) VALUES(NULL, 'BACKUP', '$usuario', '$fecha' )";
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                <label>Preciona el boton si deseas realizar una Copia de Seguridad</label>
                  ...
                  <button class="btn btn-warning" id="generar-reporte" name="generar-reporte" onclick="window.open('../../fpdf/ReporteBackstore.php')">
    <i class="zmdi zmdi-collection-pdf"></i> Generar Reporte Backup y restore
</button>  
                  </div>
                </form>
              </div>
