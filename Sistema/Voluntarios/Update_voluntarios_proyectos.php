<?php
    ...
    $query = "SELECT COUNT(*) as count FROM tbl_permisos WHERE (Estad=1 AND Permiso_consultar=1 AND Permiso_Actualizacion = 1 AND ID_Rol =? AND ID_Objeto = 15) or ('$usuario'='ADMIN')";
