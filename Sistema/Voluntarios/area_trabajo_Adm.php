    ...
    <script>
        $(document).ready(function() {
            window.addEventListener('beforeunload', function() {
                $.post('../../EVENT_BITACORA.php', { action: 'salirarea' });
            });
        });
    </script>
...
if ($datos=$sql->fetch_object()) { ?>
                         ...
                         <i class="zmdi zmdi-collection-pdf"></i> Generar Reporte Area de Trabajo
                          ...
                          <!-- PARA GENERAR LOS REPORTES ====================== -->
                            <!-- <a href="../../fpdf/ReporteAreasTrab.php?campo=" id="generar-reporte" target="_blank" class="boton-pdf"><i class="fas fa-file-pdf"><i class="zmdi zmdi-collection-pdf"></i> Generar Reporte Voluntarios por Proyectos</i></a>                -->
                          <!-- Fin Generar Reporte -->
                    ...
                    <!-- /.box-header -->
                    <!-- centro -->
                    <?php $sql=$conexion->query("SELECT * FROM tbl_permisos where (Permiso_consultar=1 and ID_Rol=$ID_Rol and ID_Objeto=14) or ('$usuario'='ADMIN')");
if ($datos=$sql->fetch_object()) { ?>
        ...
        <div class="container py-4 text-center">
            ...
            <div class="row g-4">
                ...
                <script>
                    ...
                    link.setAttribute("href", "../../fpdf/ReporteAreasTrab.php?campo=" + encodeURIComponent(campo));
                    });
                </script>
...
if ($datos=$sql->fetch_object()) { ?>
    ...
    <script>
        ...
        function getData() {
            ...
            let url = "Gestor_tbl_A_Trabajo.php"
                    ...
                    <div class="panel-body" id="formularioregistros">
                        ...
                        <div class="container">
                          ...
                          <div class="form-group col-lg-5 col-md-5 col-sm-5 col-xs-12">
                            ...
                            <input maxlength="49" oncopy="return false" type="text" class="form-control"  name="nombre_Area_Trabajo" id="nombre_Area_Trabajo" placeholder="Ingrese el nombre del Area de Trabajo" onkeypress="return /[a-zA-Z\s]/i.test(event.key)" oninput="this.value = this.value.toUpperCase();" required>
                          </div>
                          <div class="form-group col-lg-5 col-md-5 col-sm-5 col-xs-12">
                            <label>Descripcion del Area de Trabajo</label>
                            <input maxlength="99" oncopy="return false" type="text" class="form-control"  name="descripcion_A_Trabajo" id="descripcion_A_Trabajo" placeholder="Ingrese la descripcion del Area de Trabajo" onkeypress="return /[a-zA-Z\s]/i.test(event.key)" oninput="this.value = this.value.toUpperCase();" required>
                          </div>
