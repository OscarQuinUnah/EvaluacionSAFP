                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post">
                        <div class="container">
                          ...
                          <div class="form-group col-lg-5 col-md-5 col-sm-5 col-xs-12">
                            ...
                            <input onpaste="return false"  type="email" class="form-control" name="Correo_electronico" id="Correo_electronico" maxlength="39" placeholder="Ingrese el correo electronico"  value="<?php echo $correo; ?>" oninput="validarCorreo(event)" onkeydown="return evitarEspacios(event)" required>
                          </div>
