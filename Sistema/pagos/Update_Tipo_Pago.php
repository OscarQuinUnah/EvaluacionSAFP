<?php
    ...
    $query = "SELECT COUNT(*) as count FROM tbl_permisos WHERE (Estad=1 AND Permiso_consultar=1 AND Permiso_Actualizacion = 1 AND ID_Rol =? AND ID_Objeto = 17) or ('$usuario'='ADMIN')";
...
oninput="this.value = this.value.toUpperCase(); validarEspacios(this);" value="<?php echo $Nombre?>" required>
                          </div>
