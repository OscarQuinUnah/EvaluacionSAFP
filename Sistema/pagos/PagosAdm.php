    ...
    <script>
        $(document).ready(function() {
            window.addEventListener('beforeunload', function() {
                $.post('../../EVENT_BITACORA.php', { action: 'salirpago' });
            });
        });
    </script>
              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 style="text-align:center; margin-top:15px; margin-bottom:20px" class="box-title">Mantenimiento de Pagos</h1>
                          <?php $sql=$conexion->query("SELECT * FROM tbl_permisos where (Permiso_Insercion=1 and ID_Rol=$ID_Rol and ID_Objeto=10) or ('$usuario'='ADMIN')");
if ($datos=$sql->fetch_object()) { ?>
                         ...
                         <i class="zmdi zmdi-collection-pdf"></i> Generar Reporte Pago
                          </button>               
                <!-- Fin Generar Reporte -->
                    ...
                    <!-- /.box-header -->
                    <!-- centro -->
                    <?php $sql=$conexion->query("SELECT * FROM tbl_permisos where (Permiso_consultar=1 and ID_Rol=$ID_Rol and ID_Objeto=10) or ('$usuario'='ADMIN')");
if ($datos=$sql->fetch_object()) { ?>
