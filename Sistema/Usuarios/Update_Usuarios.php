...
$query = "SELECT COUNT(*) as count FROM tbl_permisos WHERE (Estad=1 AND Permiso_consultar=1 AND Permiso_Actualizacion = 1 AND ID_Rol =? AND ID_Objeto = 1) or ('$usuario'='ADMIN')";
    ...
    <?php
        ...
        if(isset($_POST['enviar'])){
            ...
            $id=$_GET['ID_Usuario']; //recuperar el id que se envia desde el home.html
             ...
             if ($id === '1') {
    echo "<script language='JavaScript'>
    alert('No puedes Editar el Administrador');
    location.assign('usuariosAdm.php');
    </script>";
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post">
                        <div class="container">
                          ...
                          <label>Correo electrónico (*):</label>
                           ...
                           <input type="email" class="form-control" name="Correo_electronico" id="Correo_electronico" maxlength="100" placeholder="Ingrese el correo electrónico"  value="<?php echo $correo; ?>" oninput="validarCorreo(event)" required>
                            </div>
                          <div class="form-group col-lg-5 col-md-5 col-sm-5 col-xs-12">
...
?>
                          <input type="password" class="form-control" id="contraseña" name="contraseña" placeholder="Ingrese su contraseña" maxlength="<?php echo $Max_Pass ?>" onkeypress="return bloquearEspacio(event);" value="<?php echo $pass; ?>" readonly>
                          ...
                          <div class="form-group col-lg-5 col-md-5 col-sm-5 col-xs-12">
                            ...
                            <input type="date" class="form-control" name="FechaVencimiento" id="FechaVencimiento" maxlength="100" placeholder="Ingrese la fecha de vencimiento" value="<?php echo $vencimiento; ?>" readonly>
                          </div>
                          <div class="form-group col-lg-5 col-md-5 col-sm-5 col-xs-12">
