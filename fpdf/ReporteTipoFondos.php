...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE TIPO DE FONDOS"), 0, 1, 'C', 0);
      $this->Ln(7);
...
$consulta_reporte_alquiler = $conexion->query("SELECT ID_tipo_fondo ,nombre_T_Fondo
...
$pdf->Output('ReporteTipoFondos.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
