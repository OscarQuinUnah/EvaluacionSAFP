...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(50, 10, utf8_decode('MONTO PAGADO'), 1, 0, 'C', 1);
      $this->Cell(60, 10, utf8_decode('TIPO PAGO'), 1, 0, 'C', 1);
      $this->Cell(65, 10, utf8_decode('PROYECTO'), 1, 0, 'C', 1);
      $this->Cell(50, 10, utf8_decode('FECHA DE TRANSACCIÓN'), 1, 1, 'C', 1);
...
while ($datos_reporte = $consulta_reporte_alquiler->fetch_object()) {   
      $i = $i + 1;
      /* TABLA */
      $pdf->Cell(35, 10, utf8_decode($i), 0, 0, 'C', 0);
      $pdf->Cell(50, 10, 'L' . number_format($datos_reporte->Monto_pagado, 2), 0, 0, 'C', 0);
      $pdf->Cell(60, 10, utf8_decode($datos_reporte -> nombre), 0, 0, 'C', 0);
      $pdf->Cell(65, 10, utf8_decode($datos_reporte -> Nombre_del_proyecto), 0, 0, 'C', 0);
